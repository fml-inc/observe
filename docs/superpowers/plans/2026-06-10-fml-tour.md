...
6. The surfaced slash-command name may be `/tour` or `/fml:tour` depending on Claude Code's plugin-command namespacing. Task 6 Step 3 records the real name after a local install; Task 7 user-facing copy MUST use that recorded name.
